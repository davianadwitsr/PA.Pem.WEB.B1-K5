...
if (isset($_GET['search']) ) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM cabang WHERE kota LIKE '%$keyword%' OR kode LIKE '%$keyword%'");
}else {
	...
	<table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?=$login['notelp']?></td>
                <td class="actions">
                    <a href="update.php?kode=<?=$login['kode']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                    <a href="delete.php?kode=<?=$login['kode']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
